    ...
    return (
         ...
         <div className='p-3 md:p-10 border-r min-h-screen w-24 md:w-64 hidden sm:block'>
            <div className='flex flex-col gap-20 sticky top-10 left-0'>
             ...
             <ul className='flex flex-col items-center md:items-start gap-11'>
...
const  MobileSideBar=()=>{
    return (
        <div className='flex justify-center gap-10 border-t fixed w-full bottom-0 left-0 bg-white z-10 p-2 sm:hidden'>
            <Link to={'/'}> <Home size={25} className='cursor-pointer'/></Link>
            <Link to={'/favorites'}><Heart size={25} className='cursor-pointer'/></Link>
